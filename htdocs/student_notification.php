        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
  					...
  					<form action="read.php" method="post">
						<?php if($not_read == '0'){
							...
							<button id="delete"  class="btn btn-success" name="read"><i class="icon-check"></i> Read</button>
					...
					?>
					<div class="alert alert-success"><strong><i class="icon-info-sign"></i> No Notifications Found</strong></div>
					<?php
					}
					?>
