					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<br>
								<button name="post" class="btn btn-success"><i class="icon-check icon-large"></i> Post</button>
								</form>
                                </div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								 ...
								 ?>
											...
											<a class="btn btn-danger"  href="#<?php echo $id; ?>" data-toggle="modal" ><i class="icon-remove"></i> </a>
											</div>
								
											<div class="pull-right">
												<form method="post" action="edit_post.php<?php echo '?id='.$get_id; ?>">
												<input type="hidden" name="id" value="<?php echo $id; ?>">
												<button class="btn btn-success" name="edit"><i class="icon-pencil"></i> </button> 
												</form>
											</div>	
