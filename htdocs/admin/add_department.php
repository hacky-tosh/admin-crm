   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class=" pull-left">Add Department</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" id="focusedInput" name="pi" type="text" placeholder = "Head of Dept">
                                          </div>
                                        </div>
											...
											<div class="control-group">
                                          <div class="controls">
												<button name="save" class="btn btn-success"><i class="icon-plus-sign icon-large"></i></button>
