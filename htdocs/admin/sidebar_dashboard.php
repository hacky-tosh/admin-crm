...
a:hover{
    ...
    <div class="span3" id="sidebar" height >
                    <ul style="background-image: url('black.png')" class="tabbable- below nav nav-pills nav-stacked color red bs-docs-sidenav nav-collapse collapse" style="background-image: url('black.png')">
                          <li class="active"> <a href="dashboard.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> 
                        </li>
                        <li>﻿</li>
                        <li>
