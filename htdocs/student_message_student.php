        ...
        <div class="container-fluid">
                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
					     <ul class="breadcrumb">
								...
								<li><a href="#"><b>School Year: <?php echo $school_year_query_row['school_year']; ?></b></a></li>
						</ul>
						 <!-- end breadcrumb -->
			...
			<form action="read_message.php" method="post">
										<div class="pull-right">
											<button class="btn btn-success" name="read"><i class="icon-check"></i> Read</button>
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class=""><a style="color: black;" href="sent_message_student.php"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
								...
								if ($count_my_message != '0'){
								 ...
								 ?>
											...
											<i class="icon-calendar"></i> <?php echo $row['date_sended']; ?>
													...
													<div class="pull-right">
													<a class="btn btn-success"  href="#<?php echo $id; ?>" data-toggle="modal" ><i class="icon-remove"></i> Remove </a>
								...
								<?php }}else{ ?>
								<div class="alert alert-Success"><i class="icon-info-sign"></i> No Messages</div>
								<?php } ?>		
								</form>		
                                </div>
                            </div>
