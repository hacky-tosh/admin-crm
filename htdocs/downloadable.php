							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									...
									<?php
										...
										if ($count == '0'){ ?>
											<div class="alert alert-success"><i class="icon-info-sign"></i> Currently you did not upload any downloadable materials</div>
						
									<?php	}else{
									?>  
  								<form action="copy_file.php" method="post">
								
									<a data-toggle="modal" href="#user_delete" id="delete"  class="btn btn-success" name=""><i class="icon-file"></i> Copy Check item</a>
