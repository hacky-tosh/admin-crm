...
<div class="span3 red" id="sidebar">
	<img id="avatar" class="img-circle" src="admin/<?php echo $row['location']; ?>">
	<?php include('teacher_count.php'); ?>
	<ul red style="background-image: url('black.png')" class="nav nav-pills nav-stacked color red bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="teacher_message.php"><i class="icon-chevron-right color"></i><i class="icon-envelope-alt"></i>&nbsp;Message</a></li> 
		<li>﻿</li>
