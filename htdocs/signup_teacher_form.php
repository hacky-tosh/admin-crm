			...
			jQuery("#signin_teacher").submit(function(e){
					...
					$.ajax({
						...
						var delay = 1000;
							...
							$.jGrowl("Your data is not present in the database", { header: 'Sign Up Failed' });
						}
						}
					});
			...
			<a onclick="window.location='index.php'" id="btn_login" name="login" class="btn btn-success" type="submit"><i class="icon-signin icon-large"></i> Back to Login</a>
