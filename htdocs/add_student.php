        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="pull-right">
							<a href="my_students.php<?php echo '?id='.$get_id; ?>" class="btn btn-success"><i class="icon-arrow-left"></i> Back</a>
						</div>
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>My Students</b></a><span class="divider">/</span></li>
