                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										...
										<li><a href="#"><b>School Year: <?php echo $school_year_query_row['school_year']; ?></b></a><span class="divider">/</span></li>
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								?>
									...
									<?php }else{ ?>
									<div class="alert alert-success"><i class="icon-info-sign"></i> No Files Inside Your Backpack.</div>
									<?php } ?>
                                </div>
                            </div>
                        </div>
