...
<?php $get_id = $_GET['id']; ?>
    <body style="background-image: url('grey.png')">
                ...
                <div class="span9" id="content">
					...
					?>
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b><?php echo $row['subject_code']; ?></b></a> <span class="divider">/</span></li>
							<li><a href="#"><b>School Year: <?php echo $row['school_year'];?></b></a> <span class="divider">/</span></li>
									...
									<ul	 id="da-thumbs" class="da-thumbs">
											...
											<li id="del<?php echo $id; ?>">
												<a  class="classmate_cursor" href="#">
														<img id="student_avatar_class" src ="admin/<?php echo $row['location'] ?>" width="124" height="140" class="img-rounded">
													<div><span></span></div>
												</a>
