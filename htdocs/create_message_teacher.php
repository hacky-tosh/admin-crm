				      ...
				      <!-- block -->
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div id="" class="pull-left"><h4><i class="icon-pencil"></i> Create Message</h4></div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
									<ul class="nav nav-tabs">
										<li>
											<a style="color: black;" href="teacher_message.php">For Teacher</a>
										</li>
										<li class="active"><a style="color: black;" href="teacher_message_teacher.php">For Student</a></li>
									</ul>
